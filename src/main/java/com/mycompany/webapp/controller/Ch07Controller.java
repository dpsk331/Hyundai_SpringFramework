...
public class Ch07Controller {
	...
	@GetMapping("/saveData")
	public String saveData(HttpServletRequest request) { // request를 통해서 각 범위의 데이터를 저장할 수 있음
		logger.info("실행");
...
//	public String argumentSaveAndRead2(@ModelAttribute("cloth") Ch07Cloth cloth) { // 명확하게 하기 위해서는 넣어주는 것이 좋음
	public String argumentSaveAndRead2(Ch07Cloth cloth) {
		logger.info("실행");
